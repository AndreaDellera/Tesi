...
\begin{itemize}
\item[-]la definizione delle reti, con l'architettura da definire come il numero di input, il numero di neuroni nello strato nascosto ed il numero di output;
...
\item[-]l'apprendimento di sequenze di note particolari, disposte a forma di cerchio o di otto;
