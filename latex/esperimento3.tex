...
Una possibile spiegazione pu\`o essere data dal fatto che quando viene fatto l'allenamento su un pezzo di database al successivo cambio, visto che alcune sequenza vengo inserite ed altre tolte, la rete trova sequenze gi\`a viste su cui fare validazione e questo potrebbe spiegare l'oscillazione dell'errore. 
\begin{figure}[!htb]
