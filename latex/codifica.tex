...
Per creare un esempio bisogna decidere quante note in input avr\`a la rete ed, in base a quello, verr\`a costruito. Un esempio per una rete con cinque note in input \`e:\\
\begin{table}[ht]
\centering
