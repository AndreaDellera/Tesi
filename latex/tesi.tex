...
\end{tabular}
\end{table}\\
Un'altra variabile che entra quando si parla di durata \`e il \emph{punto di valore} (\Pu). Questo strumento aumenta la durata della nota della sua met\`a e per codificarlo useremo un bit che sarà 0 se non c'è e 1 in caso contrario.\\
